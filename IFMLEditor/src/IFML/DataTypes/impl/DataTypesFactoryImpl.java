...
public class DataTypesFactoryImpl extends EFactoryImpl implements DataTypesFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case DataTypesPackage.SYSTEM_EVENT_TYPE:
				return createSystemEventTypeFromString(eDataType, initialValue);
			case DataTypesPackage.CONTEXT_VARIABLE_SCOPE:
				return createContextVariableScopeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case DataTypesPackage.CONTEXT_VARIABLE_SCOPE:
				return convertContextVariableScopeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public ContextVariableScope createContextVariableScopeFromString(EDataType eDataType, String initialValue) {
		ContextVariableScope result = ContextVariableScope.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertContextVariableScopeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
